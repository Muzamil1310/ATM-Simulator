...
public class Pin extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            char[] npinChars = t1.getPassword();
            char[] rpinChars = t2.getPassword();
            ...
            if (ae.getSource() == b1) {
                if (npin.isEmpty() || rpin.isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Enter both New PIN and Re-entered PIN");
                    return;
                }
                Conn c1 = new Conn();
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error occurred while changing PIN. Please try again.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
